	...
	return (
		<>
			...
			<div className="relative mt-8 space-y-1.5 text-center">
				<FeatureTitle>Skill Verification Engine</FeatureTitle>
				<FeatureDescription>
					Verify expertise with scored mock tests. Pinpoint and bridge your knowledge gaps instantly.	
				</FeatureDescription>
			</div>
		</>
	);
...
function UserBasedSecurity() {
	return (
		<>
			...
			<div className="relative mt-8 space-y-1.5 text-center">
				<FeatureTitle>ATS Optimizer</FeatureTitle>
				<FeatureDescription>
					Scan your profile against industry filters. Maximize visibility with precision-scored resumes.
				</FeatureDescription>
			</div>
		</>
	);
	...
	return (
		<>
			...
			<div className="relative z-10 mt-8 space-y-1.5 text-center">
				<FeatureTitle>Match Analytics</FeatureTitle>
				<FeatureDescription>
					Advanced NLP parsing for role compatibility. See exactly how your skills align with top jobs.
				</FeatureDescription>
			</div>
		</>
	);
		...
		<div className="grid h-full sm:grid-cols-2">
			<div className="relative z-10 space-y-6 py-8 ps-8 pe-2">
				...
				<div className="space-y-2">
					...
					<FeatureDescription>
						Build industry-ready profiles. Transform verified skills into high-converting professional narratives.
					</FeatureDescription>
				</div>
			</div>
			{/* Dashboard Screen */}
		...
		<div className="grid h-full sm:grid-cols-2 overflow-hidden items-center">
			<div className="relative z-10 space-y-6 py-8 ps-8 pe-4">
				...
				<div className="space-y-2">
					...
					<FeatureDescription>
						Real-time opportunities via web-scraping. Direct access to the latest internships and job openings.
					</FeatureDescription>
				</div>
			</div>
